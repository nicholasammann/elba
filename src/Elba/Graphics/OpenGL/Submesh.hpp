...
class Submesh : public Elba::Submesh
{
public:
  /**
  * \brief Constructor
  ...
  */
  Submesh(const std::vector<Vertex>& verts, const std::vector<Face>& faces);
  ...
  */
  ...
  void LoadTexture(Texture* texture, TextureType type = TextureType::Diffuse);
